...
function App() {
  ...
  const productData = {
    data: {
      ...
      is_enabled: newProduct.is_enabled ? 1 : 0,
      imageUrl: [...(newProduct.imagesUrl || []).filter(url => url !== "")]
    }
  };
  try {
              ...
              <tr key={product.id}>
                ...
                <td>
                  <div className="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" className="btn btn-outline-danger btn-sm" onClick={() => copyProduct(product)}>複製</button>
